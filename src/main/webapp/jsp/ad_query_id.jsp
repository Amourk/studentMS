                ...
                <div class="xjhy">
                    <ul class="hypz gjpz clearfix">
                        ...
                        <li>
                            ...
                            <div class="li_r">
                                <P name="sbir">${sbirthday}</P>
                            </div>
                        </li>
                        <li>
                            <span class="title">籍贯：</span>
                            <div class="li_r">
                                <P name="splace">${splace}</P>
                            </div>
                        </li>
                        <li>
                            <span class="title">系别：</span>
                            <div class="li_r">
                                <P name="sdep">${sdepartment}</P>
                            </div>
                        </li>
                        <li>
                            <span class="title">班级：</span>
                            <div class="li_r">
                                <P name="sclass">${sclass}</P>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="li_r">
                                <P name="sin">${sinschool}</P>
                            </div>
                        </li>
                        <li>
                            <form style="float: left" action="/deletebyid">
                                <button type="submit">删除</button>
                            </form>
                            <form style="float: left" action="/updatabyid">
