...
<div id="right_ctn">
    <div class="right_m">
        ...
        <div class="hy_list">
            ...
            <!--新建会议-->
            <form action="/updatabyname_information" method="post">
                <div class="xjhy">
                    <!--高级配置-->
                    <ul class="hypz gjpz clearfix">
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="name" type="text" value="${sname}">
                                <i>*</i>
                            </div>
                        </li>
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="sex" type="text" value="${ssex}">
                                <i>*</i>
                            </div>
                        </li>
                        <li class="clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="class" type="text" value="${sclass}">
                                <i>*</i>
                            </div>
                        </li>
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="department" type="text" value="${sdepartment}">
                                <i>*</i>
                            </div>
                        </li>
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="place" type="text" value="${splace}">
                                <i>*</i>
                            </div>
                        </li>
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="inschool" type="text" value="${sinschool}">
                                <i>*</i>
                            </div>
                        </li>
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="birthday" type="text" value="${sbirthday}">
                                <i>*</i>
                            </div>
                        </li>
                        <li class="tj_btn">
